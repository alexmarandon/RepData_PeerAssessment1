...
The mean and median values of this distribution are respectively `r mean` and `r median`.
...
The mean and median values are respectively `r mean_nafill` and `r median_nafill`.
